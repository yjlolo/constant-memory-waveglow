...
from utils.midi_util import parse_midi
...
class PianoRollAudioDataset(Dataset):
    ...
    def __init__(self, path, size, groups=None, sequence_length=None, seed=42, refresh=False, device=DEFAULT_DEVICE):
        self.path = path
        self.size = size
    ...
    def _create_maestro_and_emotion_dataset(self):
        ...
        # with open("maestro-v2.0.0.json", "r+") as f:
...
class MAESTRO(PianoRollAudioDataset):
    ...
    def __init__(self, size, path='../../MAESTRO/', groups=None, sequence_length=None, seed=42, refresh=False, device=DEFAULT_DEVICE):
        # super().__init__(path, groups if groups is not None else ['train'], sequence_length, seed, refresh, device)
        super().__init__(path, size, groups if groups is not None else ['train'], sequence_length, seed, refresh, device)
